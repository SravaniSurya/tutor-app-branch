...
public class ParentSignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_forgotPassword.setOnClickListener(v -> startActivity(new Intent(ParentSignIn.this, ParentResetPasswordActivity.class)));
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.exists()) {
                        for (DataSnapshot tutorSnapshot : dataSnapshot.getChildren()) {
                            Parent parent = tutorSnapshot.getValue(Parent.class);
    ...
    private void sendUserToMainActivity(Parent parent) {
        ...
        ((TutorApplication) getApplicationContext()).parent = parent;
