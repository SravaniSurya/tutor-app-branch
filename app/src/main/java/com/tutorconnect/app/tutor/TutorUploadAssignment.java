...
public class TutorUploadAssignment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutor_upload_assignment);
    ...
    private void uploadFileToFirebase(Uri data, String name) {
        ...
        reference.putFile(data)
                .addOnSuccessListener(taskSnapshot -> {
                    ...
                    AssignmentNotes assignment = new AssignmentNotes(id, name, uri.toString(), tutor.getId());

                    databaseReference.child("assignment").child(id).setValue(assignment);

                    Toast.makeText(TutorUploadAssignment.this, "Assignment Uploaded", Toast.LENGTH_SHORT).show();
